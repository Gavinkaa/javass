...
class Bits64Test {
    ...
    void maskFailsWithNegativeStart() {
        ...
        for (int i = 0; i < RANDOM_ITERATIONS; ++i) {
            ...
            assertThrows(IllegalArgumentException.class, () -> Bits64.mask(start, size));
        }
    }
    ...
    void extractFailsWithNegativeStart() {
        ...
        for (int i = 0; i < RANDOM_ITERATIONS; ++i) {
            int start = -(i + 1);
            int size = rng.nextInt(Long.SIZE + 1);
            assertThrows(IllegalArgumentException.class, () -> Bits64.extract(rng.nextLong(), start, size));
        }
    }
    ...
    void pack2FailsWithTooBigValues() throws Exception {
        assertThrows(IllegalArgumentException.class, () -> Bits64.pack(0b100, 2, 0b11, 2));
        assertThrows(IllegalArgumentException.class, () -> Bits64.pack(0b100, 3, 0b11, 1));
    }

    @Test
    void pack2FailsForTooManyBits() throws Exception {
        assertThrows(IllegalArgumentException.class, () -> Bits64.pack(0, 32, 0, 33));
    }
